...
# Diary
  ...
  Content: 
    Today, we found a problem again. the motor's fixed mount are broke, we need to find a batter's solution. we redesign car's chassis, modified the design many times.   finally, the chassis was done, it can very strong to fixed the motor, and width reduced by 13%, we think this is very proud moment.
  ...
  工作內容: 
    今天，我們又發現了一個問題。電機的固定架壞了，我們需要尋找一個電池的解決方案。我們重新設計了汽車的底盤，多次修改設計。終於，底盤做好了，可以很結實的固定電機，寬度減少了13%，我們覺   得這是一個非常自豪的時刻。
